# -*- coding: utf-8 -*-
"""
민담_대본.py — 야담·민담·옛이야기 대본 자동 생성 (v11.3 main 지침을 DeepSeek 한 번 실행으로 옮긴 판)
...
비트_이름 = {"①": "오프닝 이미지", "②": "주제 명시", "③": "설정", "④": "기폭제", "⑤": "토론", "⑥": "2막 진입", "⑦": "B스토리",
          "⑧": "재미와 놀이", "⑨": "중간점", "⑩": "악당의 역습", "⑪": "절망의 순간", "⑫": "영혼의 어두운 밤", "⑬": "3막 진입",
          "⑭": "피날레", "⑮": "마지막 이미지", "엔딩": "엔딩"}
# 챕터 분할: (비트, 비중) — 0.5 는 그 비트의 전반/후반
길이 = {
    "0": dict(이름="2분 테스트", 총글자=600, 챕터=[
        [("①", 1), ("②", 1), ("③", 1), ("④", 1), ("⑤", 1), ("⑥", 1), ("⑦", 1), ("⑧", 1),
         ("⑨", 1), ("⑩", 1), ("⑪", 1), ("⑫", 1), ("⑬", 1), ("⑭", 1), ("⑮", 1), ("엔딩", 1)]]),
