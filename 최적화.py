...
최적화.py — 완성 대본 → 유튜브 알고리즘용 메타데이터 (제목 후보·썸네일 문구·설명글·태그·고정댓글·첫 30초 점검·업로드 시각)
  ...
  트렌드: 트렌드.json (사람의 이유) / 민담_트렌드.json (민담) — 주제뽑기가 저장한 "요즘 터지는 단어"
  결과: 대본 옆에 *_유튜브최적화.txt (사람의 이유) / 유튜브_최적화.txt (민담)
...
채널_설명 = {
    "person": "채널 '사람의 이유' — 사람·관계·심리·인생·돈을 '왜 그럴까'로 풀어 주는 정보형 롱폼. 시청자 40~60대.",
